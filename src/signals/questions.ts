...
const questionBySignalId = new Map<string, string>([
  ...
  ["secret_related_change", "Les changements lies aux secrets ou cles evitent-ils d'exposer des valeurs sensibles ?"],
  ...
  ["mixed_concerns", "Quels changements doivent etre relus ensemble et lesquels peuvent etre separes ?"]
]);
