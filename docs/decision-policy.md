...
5. `dependency_review` when both dependency manifest and lockfile changed.
...
A dependency PR with a manifest and lockfile normally recommends `dependency_review`.
